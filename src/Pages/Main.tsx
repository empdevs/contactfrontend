import { ActionButton, DefaultButton, DetailsList, DetailsListLayoutMode, IColumn, IIconProps, PrimaryButton, SelectionMode, Stack, TextField, mergeStyleSets, Text, MessageBar, MessageBarType } from '@fluentui/react';
...
const Main: React.FC = () => {
    ...
    async function deleteContact(id: string) {
        try {
            const { error: error, message: message, status: status } = await axiosService.delete(Uri.deleteContact + `/${id}`);
            if (error) {
    ...
    function onRenderFooter(): JSX.Element {
        return (
            <Stack
                horizontal
                horizontalAlign="end"
        ...
        <>
            ...
            <div className={styles.wrapper}>
                ...
                <DialogBasic
                    ...
                    onSaveButton={() => deleteContact(idContact)}
